...
<body>
			...
			<div class="sch_box">
				<ul>
					...
					<li class="sc3">
						...
						<label for="nMng" class="txtControl">미조치</label>
						
						<input type="radio" id="nCmp" name="option2" value="cmp_yn" onkeyup="enterkey();"/>
						<label for="nCmp" class="txtControl">미완료</label>
					</li>
					<li class="sc4">
	...
	function read(data){
		...
		$('#rsk_file_ps').val(data.rsk_file_ps);
		$('#rskok_file_txt').val(data.rskok_file); 
		$('#rskok_file_ps').val(data.rskok_file_ps); 
	}//read
